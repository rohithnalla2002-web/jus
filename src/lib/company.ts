...
/** E.164 for `tel:` links */
export const COMPANY_PHONE_E164 = "+919502201143";

/** Spaced for display (same number as E.164). */
export const COMPANY_PHONE_DISPLAY = "+91 95022 01143";

export const COMPANY_ADDRESS_LINE1 = "Jacinta Gardens";

export const COMPANY_ADDRESS_CITY_PIN = "Hyderabad, Telangana 50055";
...
export const KARIGAR_RECEIPT_FOOTER_NOTE = `Generated from ${GOLDMIND_APP_NAME} Admin Dashboard · ${COMPANY_LEGAL_NAME} · Karigar workshop record.`;
